...
describe('TextProcessorAPI', () => {
  it('#build', () => {
    ...
    it('#divideTextInColumns', () => {
      //como estamos trabalhando com FluentAPI trabalhamos com o valor anterior
      const content = [
        [
          "Xuxa da Silva, brasileira, casada, CPF 235.743.420-12, residente e ",
          "domiciliada a Rua dos bobos, zero, bairro Alphaville, São Paulo. "
      ...
      //como estamos trabalhando com FluentAPI trabalhamos com o valor anterior, por isso passando o content, pois imaginamos queja foi pre processado
