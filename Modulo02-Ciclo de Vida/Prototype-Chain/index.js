...
//internamente, objeto=s literais viram funções explicitas
...
// o __proto de Object.prototype é null
//podemos assumir que tudo no JS herda de object e no fim tudo herda de null
...
//podemos chamar via protype,mas se tentar chamar direto, vai dar erro!
console.log('Employee.prototype.salary()',Employee.prototype.salary())
// cosole.log('Employee.salary()',Employee.salary())

//se não chamar o 'new', o primeiro __proto__ vai ser sempre a instancia de Function,
...
//quado chamamos com 'new', o __proto__ receber o prototype 
